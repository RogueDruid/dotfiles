...
() {
  ...
  # typeset -g POWERLEVEL9K_DIR_BACKGROUND=4 # original
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=232 # clown
  # Default current directory foreground color.
  # typeset -g POWERLEVEL9K_DIR_FOREGROUND=254 # original
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=7 # clown
  ...
  # typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=250 # original
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND= # clown
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  # typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=255 # original
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=7 # clown
